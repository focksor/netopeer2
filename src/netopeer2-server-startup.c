/**
 * @file netopeer2-server-startup.c
 * @author focksor <focksor@outlook.com>
 * This file contains the startup code, which was defined in main.c
 *
 * The code is moved here to make netopeer-server to be a dynamic library
...
#ifdef _GNU_SOURCE
    char thread_name[16];
    snprintf(thread_name, sizeof(thread_name), "np2-worker-%d", idx);
...
#endif /* Source code that export APIs */
